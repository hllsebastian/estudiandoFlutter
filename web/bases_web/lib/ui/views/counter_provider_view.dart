...
class CounterProviderView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (_) =>
            CounterProvider(), // Se consumiran los metodos de esta clase
...
class _CounterProviderPageBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(       // Aca se quito el Scaffold***
      ...
      children: [
        ...
        FittedBox(
          // Para que el contenido mostrado en pantalla se ajuste
        ...
        Row(
          ...
          children: [
            CustomFlatButtom(
                text: 'Incrementar',
                onPressed: () =>
                    counterProvider.increment() // Consumiento Provider
                ),
            CustomFlatButtom(
                text: 'Decrementar',
                onPressed: () =>
                    counterProvider.decrement() // Consumiento Provider
                ),
          ],
        ),
        Spacer(),
